                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="p-5">
                                ...
                                <?php endif; ?>
                                <form class="user" method="POST" action="<?php echo e(route('admin.login.post')); ?>">
                                    <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\Sefa\Desktop\blog\resources\views/back/auth/login.blade.php ENDPATH**/ ?>